	...
	<div class="row container-fluid p-4">
		...
		<div id="menu" class="collapse navbar-collapse col-lg-7 col-xl-9">
			 <ul class="nav nav-justified ml-auto col-3 col-sm-3 col-md-9 col-lg-12 col-xl-12">
				<li class="nav-item "><a class="nav-link menu-item item-name active" href="#">Vegetable</a></li>
				<li class="nav-item"><a class="nav-link menu-item item-name" href="../cart/index.php">Cart</a></li>
				<?php  
					if(isset($_SESSION['login']) && $_SESSION['login'] == true){
						...
						echo 	"<li class='nav-item'><a class='nav-link menu-item item-name active' href='../cart/history.php' >History</a></li>";
