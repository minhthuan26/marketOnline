<nav class="nav nav-tabs navbar-dark bg-dark navbar-expand-md">
	<div class="row container-fluid p-4">
		<a id="logo" class="navbar-brand col-9 col-sm-9 col-md-3 col-lg-4 col-xl-3" href="#">Market online<a>
			 ...
			 <ul class="nav nav-justified ml-auto col-3 col-sm-3 col-md-9 col-lg-12 col-xl-12">
				...
				<?php  
					if(isset($_SESSION['login']) && $_SESSION['login'] == true){
						...
						if($userName != false){
							echo 	"<li class='nav-item'><a class='nav-link menu-item item-name' href='cart/index.php'>Cart</a></li>";
							echo 	"<li class='nav-item'><a class='nav-link menu-item item-name' href='cart/history.php'>History</a></li>";
						...
						echo 	"<li class='nav-item'><a class='nav-link menu-item item-name disabled' href='#'>Cart</a></li>";
						echo 	"<li class='nav-item'><a class='nav-link menu-item item-name disabled' href='#' >History</a></li>";
